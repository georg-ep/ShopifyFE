<template>
  <div class="container">
    <div class="container_content-smaller">
      <div class="title ta-c">Terms of service</div>
      <div>
        Welcome to our store! These Terms of Service (“Terms”, “Terms of
        Service”) govern your use of our website located at goshopthemarket.com
        (together or individually “Service”) operated by GoShopTheMarket ©. Our
        ...
        Service, but please let us know by emailing at support@goshopthemarket.com
      ...
      <div class="title">CONTESTS, SWEEPSTAKES AND PROMOTIONS</div>
      <div>
      ...
      <div>
        We issue refunds for Contracts within 60 days of the original purchase
        of the Contract.
      </div>
      <div class="title">CONTENT</div>
      <div>
        Content found on or through this Service are the property of GoShopTheMarket ©
      ...
      <div>
        ...
        purpose of exploiting, harming, or attempting to exploit or harm minors
        in any way by exposing them to inappropriate content or otherwise. 0.3.
        ...
        other similar solicitation. 0.4. To impersonate or attempt to
        impersonate Company, a Company employee, another user, or any other
        person or entity. 0.5. In any way that infringes upon the rights of
        others, or in any way is illegal, threatening, fraudulent, or harmful,
        or in connection with any unlawful, illegal, fraudulent, or harmful
        purpose or activity. 0.6. To engage in any other conduct that restricts
        or inhibits anyone’s use or enjoyment of Service, or which, as
        determined by us, may harm or offend Company or users of Service or
        expose them to liability. Additionally, you agree not to: 0.1. Use
        Service in any manner that could disable, overburden, damage, or impair
        Service or interfere with any other party’s use of Service, including
        their ability to engage in real time activities through Service. 0.2.
        ...
        material which is malicious or technologically harmful. 0.6. Attempt to
        ...
        denial-of-service attack or a distributed denial-of-service attack. 0.8.
        Take any action that may damage or falsify Company rating. 0.9.
      ...
      <div class="title">NO USE BY MINORS</div>
      <div>
      ...
      <div>
        ...
        GoShopTheMarket © and its licensors. Service is protected by copyright,
        ...
        written consent of GoShopTheMarket ©.
      </div>
      <div class="title">COPYRIGHT POLICY</div>
      ...
      person or entity. If you are a copyright owner, or authorized on behalf of
      one, and you believe that the copyrighted work has been copied in a way
      that constitutes copyright infringement, please submit your claim via
      email to support@goshopthemarket.com, with the subject line: “Copyright
      ...
      for Copyright Infringement Claims” You may be held accountable for damages
      (including costs and attorneys’ fees) for misrepresentation or bad-faith
      claims on the infringement of any Content found on and/or through Service
      on your copyright.
      <div class="title">DMCA NOTICE AND PROCEDURE FOR COPYRIGHT INFRINGEMENT CLAIMS</div>
      <div>
        You may submit a notification pursuant to the Digital Millennium
        Copyright Act (DMCA) by providing our Copyright Agent with the following
        information in writing (see 17 U.S.C 512(c)(3) for further detail): 0.1.
        an electronic or physical signature of the person authorized to act on
        behalf of the owner of the copyright’s interest; 0.2. a description of
        the copyrighted work that you claim has been infringed, including the
        URL (i.e., web page address) of the location where the copyrighted work
        exists or a copy of the copyrighted work; 0.3. identification of the URL
        or other specific location on Service where the material that you claim
        is infringing is located; 0.4. your address, telephone number, and email
        address; 0.5. a statement by you that you have a good faith belief that
        the disputed use is not authorized by the copyright owner, its agent, or
        the law; 0.6. a statement by you, made under penalty of perjury, that
      ...
      <div class="title">ERROR REPORTING AND FEEDBACK</div>
      <div>
        You may provide us either directly at support@goshopthemarket.com or via
      ...
      <div>
        ...
        are not owned or controlled by GoShopTheMarket ©. GoShopTheMarket © has no control
        over, and assumes no responsibility for the content, privacy policies,
        or practices of any third party web sites or services. We do not warrant
        ...
        SERVICE AND PRIVACY POLICIES OF ANY THIRD PARTY WEB SITES OR SERVICES
        THAT YOU VISIT.
      </div>
      <div class="title">DISCLAIMER OF WARRANTY</div>
      <div>
      ...
      <div>
        ...
        of Lithuania, which governing law applies to agreement without regard to
      ...
      <div class="title">CHANGES TO SERVICE</div>
      <div>
      ...
      <div class="title">AMENDMENTS TO TERMS</div>
      <div>
      ...
      <div class="title">WAIVER AND SEVERABILITY</div>
      <div>
      ...
      <div class="mb-24">
        ...
        email: support@goshopthemarket.com
      </div>
    </div>
  </div>
</template>
